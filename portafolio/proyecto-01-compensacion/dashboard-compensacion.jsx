...
export default function Dashboard() {
  ...
  return (
    <div style={{ background: BG, minHeight: "100vh", fontFamily: "'IBM Plex Sans', sans-serif", color: INK }}>
      ...
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Newsreader:ital,wght@0,400;0,600;1,400&family=IBM+Plex+Sans:wght@400;500;600&family=IBM+Plex+Mono:wght@400;500&display=swap');
